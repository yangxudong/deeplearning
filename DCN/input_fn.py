...
def create_feature_columns():
  ...
  city = fc.indicator_column(fc.categorical_column_with_hash_bucket("city", 700))
  ...
  ipv_ntile = fc.indicator_column(fc.categorical_column_with_identity("ipv_ntile", num_buckets=101, default_value=0))
  pay_ntile = fc.indicator_column(fc.categorical_column_with_identity("pay_ntile", num_buckets=101, default_value=0))
  ...
  my_feature_columns = [matchScore, matchType, postition, triggerNum, triggerRank, sceneType, hour,
    phoneBrand, phoneResolution, phoneOs, tab, popScore, sellerPrefer, brandPrefer, cate2Prefer, catePrefer,
